...
class Solution {
    public int[] nodesBetweenCriticalPoints(ListNode head) {
        ...
        boolean flag = false; // to make sure the distance updation starts aftr any one critical pointe encounterance
        while (cur.next!=null) {
            if ((cur.val < prev.val && cur.val < cur.next.val) || (cur.val > prev.val && cur.val > cur.next.val)) {
                ...
                dis1=1; //reset dis1 to 1, min dis is dis bet 2 critical nodes
